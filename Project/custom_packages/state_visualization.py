...
from qiskit.visualization.array import _num_to_latex, array_to_latex
...
def plot_bloch_vector(
    bloch, title="", ax=None, figsize=None, coord_type="cartesian", font_size=None, sphere_alpha=0.2
):
    ...
    if figsize is None:
        figsize = (5, 5)
    B = Bloch(axes=ax, font_size=font_size, sphere_alpha=sphere_alpha)
